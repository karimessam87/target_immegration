    ...
    <div class="col-auto float-right ml-auto">
      ...
      <div class="view-icons">
        <a href="{{route('clients.index')}}"
           class="grid-view btn btn-link {{route_is('clients.index') ? 'active' : '' }}"><i
            class="fa fa-th"></i></a>
              ...
              <tr>
                <td>
                  <h2 class="table-avatar">
                    <a href="client-profile.html" class=" avatar avatar-fix"><img class="avatar-fix"
                                                                                  src="{{$client->avatar()}}"
                                                                                  alt=""></a>
                ...
                <td class="text-right">
                  <div class="dropdown dropdown-action">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                      <a data-id="{{$client->id}}"
                         data-firstname="{{$client->firstname}} data-middlename="{{$client->middlename}}
                      "
                      ...
                      <a data-id="{{$client->id}}" class="dropdown-item deletebtn"
                         href="javascript:void(0)" data-toggle="modal"><i
                  ...
                  <div class="modal-body">
                    ...
                    <form method="POST" enctype="multipart/form-data"
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="col-form-label">Middle Name <span
                                class="text-danger">*</span></label>
