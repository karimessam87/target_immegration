      ...
      <div class="card-group m-b-30">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="mb-3">{{$latest_employee_count}}</h3>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="mb-3">{{$latest_tickets_count}}</h3>
            <div class="progress mb-2" style="height: 5px;">
              <div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40"
                   aria-valuemin="0" aria-valuemax="100"></div>
            </div>
            <p class="mb-0">Previous Month <span class="text-muted">{{$last_month_tickets_count}}</span></p>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p class="mb-0">Previous Month <span class="text-muted">5</span></p>
          </div>
        </div>
      ...
      <div class="card flex-fill dash-statistics">
        <div class="card-body">
          ...
          <div class="stats-list">
            ...
            <div class="stats-info">
              <p>Completed Tasks <strong>85 <small>/ 112</small></strong></p>
              <div class="progress">
    ...
    <div class="col-md-12 col-lg-6 col-xl-4 d-flex">
      <div class="card flex-fill">
        <div class="card-body">
          ...
          <div>
            <p><i class="fa fa-dot-circle-o text-purple mr-2"></i>Completed Tasks <span class="float-right">166</span>
            </p>
            <p><i class="fa fa-dot-circle-o text-warning mr-2"></i>Inprogress Tasks <span class="float-right">115</span>
            </p>
        ...
        <div class="card-body">
          ...
          <div class="leave-info-box">
            <div class="media align-items-center">
              <a href="profile.html" class="avatar avatar-unset"><img alt="" src="assets/img/user.jpg"></a>
