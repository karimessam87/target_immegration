...
@section('page-header')
  <div class="row align-items-center">
    <div class="col">
      <h3 class="page-title">Set Types</h3>
      <ul class="breadcrumb">
      ...
      <div class="alert-heading mt-2">
        <h5 class="text-secondary">
          This Types is public use to file,client,employee,or even ur coffee
        </h5>
    ...
    <div class="col-auto float-right ml-auto">
      ...
      <div class="view-icons">
        <a href="{{route('document.types.index')}}"
           class="grid-view btn btn-link {{route_is('document.types.index') ? 'active' : '' }}"><i
            class="fa fa-th"></i></a>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" enctype="multipart/form-data"
                    action="{{route('document.types.update',$type)}}">
                @csrf
                @method("PATCH")
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="label_id" class="col-form-label">Select A Label</label>
                      <select name="label_id" id="label_id">
                        ...
                        @foreach($labels as $label)
                          <option
                            {{$type->label->id == $label->id ? 'selected' : ''}}
                            value="{{$label->id}}">
                            {{$label->name}}
                          </option>
                        @endforeach
