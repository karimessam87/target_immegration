                ...
                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                    <div class="profile-widget">
                        <div class="profile-img">
                            <a href="javascript:void(0)" class="avatar employee">
                                <img alt="avatar"
                                     src="{{$employee->avatar()}}"></a>
                        </div>
                        <div class="dropdown profile-action">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a data-id="{{$employee->id}}" data-firstname="{{$employee->firstname}}"
                                   ...
                                   data-department="{{$employee->department->id}}" class="dropdown-item editbtn"
                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('employee.add')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label">Employee CV<span
                                            class="text-danger">*</span></label>
                    ...
                    <form method="POST" action="{{route('employee.update')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="col-form-label">password <span class="text-danger">*</span></label>
                                    <input class="form-control edit_store" name="password" type="password"
                                           placeholder="You don't have to change it">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="col-form-label">Salary <span class="text-danger">*</span></label>
                                    <input class="form-control edit_salary" name="salary" type="number">
                            ...
                            <div class=" col-md-6">
                                <div class="form-group">
                                    <label>Designation <span class="text-danger">*</span></label>
                                    <select name="designation" selected="selected"
                                            class="select edit_designation">
                            ...
                            <div class=" col-md-6">
                                <div class="form-group">
                                    <label class="col-form-label">Employee Picture<span
                                            class="text-danger">*</span></label>
                                    <input class="form-control floating edit_avatar"
