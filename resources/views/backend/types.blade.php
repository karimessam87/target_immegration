...
@section('page-header')
    <div class="row align-items-center">
        <div class="col">
            <h3 class="page-title">Client Types</h3>
            <ul class="breadcrumb">
                ...
                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                    <div class="profile-widget">
                        <div class="profile-img">
                            <a href="javascript:void(0)" class="avatar backgroundData"
                        ...
                        <h6
                            ...
                            <a class="badge {{$type->status ? 'badge-success' : 'badge-danger'}}"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" enctype="multipart/form-data"
                                  action="{{route('clients.types.update',$type)}}">
                                @csrf
                                @method("PATCH")
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <label class="m-5">
                                                Enabled
                                                <input class="form-control floating" id="Enabled"
                                                       name="status" value="1"
                                                       type="radio"
                                                    {{$type->status ? 'checked' : ''}}
                                                >
                                            ...
                                            <label>
                                                Disabled
                                                <input class="form-control floating" id="Disabled" name="status"
                                                       value="0"
                                                       {{$type->status ? '' : 'checked'}}
                                                       type="radio">
                                            </label>
    ...
    <div id="add_type" class="modal custom-modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" enctype="multipart/form-data" action="{{route('clients.types.store')}}">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label class="m-5">
                                        Enabled
                                        <input class="form-control floating" id="Enabled" name="status" value="1"
                                               type="radio">
                                    </label>
                                    <label>
                                        Disabled
                                        <input class="form-control floating" id="Disabled" name="status" value="0"
                                               type="radio">
                                    </label>
                                </div>
                            </div>
