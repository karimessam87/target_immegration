...
<div class="main-wrapper">
    <div class="account-content">
        ...
        <div class="container">
            ...
            <!-- Account Logo -->
            <div class="account-logo login-logo">
                <a href=""><img
                        src="{{!empty(app(App\Settings\ThemeSettings::class)->logo) ? asset('storage/settings/'.app(App\Settings\ThemeSettings::class)->logo):asset('assets/img/login-logo.png')}}"
                        alt="logo"></a>
            </div>
            <!-- /Account Logo -->
