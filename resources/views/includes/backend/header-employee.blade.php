...
<div class="header">
  ...
  <div class="header-left">
    <a href="{{route('dashboard')}}" class="logo">
      <img
        src="{{!empty(app(App\Settings\ThemeSettings::class)->logo) ? asset('storage/settings/'.app(App\Settings\ThemeSettings::class)->logo):asset('assets/img/logo.png')}}"
  ...
  <ul class="nav user-menu">
    ...
    <li class="nav-item dropdown">
      <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
        <i class="fa fa-bell-o"></i> <span
          class="badge badge-pill">{{auth()->user()?->notifications->count()}}</span>
      </a>
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      <p class="noti-details"><span
                          class="noti-title">{{auth()->user()->name}}</span> {{$notification->type}}
    ...
    <li class="nav-item dropdown has-arrow main-drop">
      ...
      <div class="dropdown-menu">
        ...
        <form action="{{route('employees.logged.logout')}}" method="post">
          @csrf
