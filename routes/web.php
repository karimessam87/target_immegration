...
use App\Http\Controllers\Admin\Client\ClientDetailController;
...
use App\Http\Controllers\Admin\Task\TaskTypeCpntroller;
use App\Http\Controllers\CanadianConnectionController;
use App\Http\Controllers\FinicialReportController;
...
Route::group(['middleware' => ['auth']], function () {
  Route::view('permissions-view', 'backend.roles-permissions');
...
//    Route::delete('clients', [ClientController::class, 'destroy'])->name('client.destroy');
  ...
  Route::get('hoda', [BackupsController::class, 'index'])->name('backups');
